...
<h1 id="cats-example">Cats example v1.0</h1>
...
<h1 id="cats-example-default">Default</h1>
...
|Status|Meaning|Description|Schema|
|---|---|---|---|
|200|[OK](https://tools.ietf.org/html/rfc7231#section-6.3.1)|Returns al of the PestoContentType s|Inline|

<h3 id="pestocontenttypecontroller_index-responseschema">Response Schema</h3>
...
## PestoContentTypeController_findByProject

<a id="opIdPestoContentTypeController_findByProject"></a>

> Code samples

`GET /pesto-content-type/project/{project_id}`

<h3 id="pestocontenttypecontroller_findbyproject-parameters">Parameters</h3>

|Name|In|Type|Required|Description|
|---|---|---|---|---|
|project_id|path|string|true|none|

<h3 id="pestocontenttypecontroller_findbyproject-responses">Responses</h3>
